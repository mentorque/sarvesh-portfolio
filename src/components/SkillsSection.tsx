  ...
  const skillCategories = [
    {
      ...
      skills: ["Inventory Management", "Logistics Coordination", "Demand Forecasting"],
    },
    {
      title: "Operations & Planning",
      skills: ["Manufacturing Operations", "Production Scheduling", "Material Planning"],
    },
    {
      title: "Procurement & Processes",
      skills: ["Procurement Coordination", "Vendor Management", "Process Improvement"],
    },
    {
      title: "Analysis & Professional",
      skills: [
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Supply chain operations, procurement, and analytics.
            </p>
          </div>
